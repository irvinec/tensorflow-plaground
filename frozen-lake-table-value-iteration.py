...
def main():
    ...
    # Get the state value function table for the optimal policy
    # BUG this is none.
    optimal_value_table = value_iteration(env)

    # Now that we have the optimal value function in terms of table (value_table)
...
def value_iteration(env):
    ...
    # while V(s) not converged:
    #   for state in States:
    #       for action in Actions:
    #           Q(s,a) <- R(s,a) + DISCOUNT_FACTOR*sum(T(s,a,s')*V(s'))
